...
> YouTube Shorts & Longform 영어 학습 비디오를 자동으로 생성하는 AI 프로그램

매일 3개의 영어 문장만 입력하면, AI가 자동으로 이미지를 생성하고, 음성을 만들고, 전문적인 유튜브 영상을 제작합니다!
...
- 📱 **2가지 비디오 포맷**: Shorts (9:16, 세로) + Longform (16:9, 가로) 동시 지원
- 👧 **Kelly 캐릭터 브랜딩**: 인트로/아웃트로에 전체 화면 Kelly 캐릭터 배경
- 🎯 **5가지 학습 포맷**: 매일 3문장, 테마별 묶음, 퀴즈 챌린지, 속어 비교, 랜드마크 영어
- 🎨 **커스텀 인트로/아웃트로**: 비디오별 DALL-E 3 배경 이미지 생성
- ✏️ **비디오 편집 기능**: 웹 UI에서 문장, 음성, 타이밍 등 세부 편집 가능
- ⚡ **빠른 제작**: 영상 1개당 3분 이내 자동 생성

### 🖼️ 썸네일 스튜디오 🆕
- 🎨 **Fire English 스타일**: CTR 최적화 썸네일 자동 생성
- 🎥 **YouTube 통합**: URL 입력만으로 비디오 프레임 3개 자동 추출
- ✏️ **텍스트 편집**: 배경 이미지 보존하며 텍스트만 빠르게 수정
- 📊 **숫자 배지**: 문장 개수, 영상 길이 자동 표시
- 🎨 **채널 브랜딩**: 채널 아이콘, 브랜드 색상 자동 적용
- 📂 **히스토리 관리**: 모든 버전 자동 저장, 언제든 다시 사용
- 📥 **고화질 다운로드**: 1280x720 PNG (YouTube 최적화)

### 📊 YouTube 최적화
- 🔍 **SEO 자동화**: GPT-4o로 제목, 설명, 태그 자동 생성
- 📈 **구독자 성장 전략**: 바이럴 훅, 댓글 유도 CTA 자동 삽입
- 🎯 **타겟 최적화**: 포맷별 맞춤 메타데이터 (랜드마크: 여행+영어 니치)
...
- **[PROMPTS.md](./PROMPTS.md)** - AI 프롬프트 통합 문서 (GPT/DALL-E/TTS)
- **[CLAUDE.md](./CLAUDE.md)** - 개발 컨텍스트 및 변경 이력
